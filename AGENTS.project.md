...
- Apple Pencil Template Studio with orientation-tagged built-in packs (30 landscape + 30 portrait)
- Built-in folder filters include In Progress (with a live count badge), Favorites, Recent, Completed, Landscape/Portrait, three complexity folders (Easy/Medium/Detailed), and manifest-driven shelf folders (Cozy, Nature, Animals, Fantasy, Patterns, Seasonal) with multi-folder membership support
