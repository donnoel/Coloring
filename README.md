...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Templates-50%20Built--In-purple">
...
- **Category Folders**: Use built-in filters including `In Progress` (with a live count badge), `Favorites`, `Recent`, `Completed`, `Imported`, shelf folders (`Animals`, `Aviation`, `Cities & Architecture`, `Cozy`, `Fantasy`, `Motorsport`, `Nature`, `Science & Technology`, `Space & Sci-Fi`), and orientation folders (`Landscape`, `Portrait`).
